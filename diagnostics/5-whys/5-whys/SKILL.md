...
name: 5-whys
description: |
  Conducts iterative root cause analysis to drill down from surface symptoms to fundamental systemic issues using the Five Whys methodology.
...
When a user presents a problem, follow these steps:

1. **Clarify the problem**: Ensure you understand the specific issue they're describing
2. **Conduct the analysis**: Walk through each "why" level systematically
3. **Look for patterns**: Is this a one-time issue or recurring?
4. **Distinguish symptoms from causes**: Don't stop at surface-level explanations
5. **Propose corrective actions**: Both immediate fixes and systemic improvements
6. **Suggest verification**: How to test that you've identified the true root cause

## When to Apply

- Debugging software issues
- Investigating production incidents
- Understanding customer complaints or churn
- Process failures
- Quality issues
- Performance problems
- Any situation where "something went wrong" and you need to understand why

## When NOT to Use

- When the problem is already well-understood
- When immediate action is required and analysis would delay critical response
- When you don't have enough information to answer factual questions
- When further "why" questions lead to philosophical or unanswerable territory
